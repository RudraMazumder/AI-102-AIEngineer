...
def main():
    ...
    try:
        ...
        if command == '1':
            ...
            names = ['Aisha', 'Pama', 'Rudra']
            TrainModel('employees_group', 'employees', names)
        elif command =='4':
            RecognizeFaces(os.path.join('images','rudra-teams.png'), 'employees_group')
        elif command == '5':
            VerifyFace(os.path.join('images','rudra3.jpg'), 'Rudra', 'employees_group')
